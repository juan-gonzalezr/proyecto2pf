...
export default class datosV extends Component {
...
state1={
  ...
  async componentDidMount(){
    const res = await axios.get("http://localhost:4000/Serial/datv");
  ...
  onSubmit=async e=>{
    e.preventDefault();
    const res=await axios.get("http://localhost:4000/Serial/datv"+"/"+this.state.direccion)
    ...
    // })
    console.log("http://localhost:4000/Serial/datv"+"/"+this.state.direccion);
  }
  render() {
